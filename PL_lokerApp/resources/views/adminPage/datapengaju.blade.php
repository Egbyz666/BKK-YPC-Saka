            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr style="font-family: Arial, Helvetica, sans-serif">
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 ">Jenis Loker</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ">Pernyataan</th>
              ...
              <tbody style="font-family: Arial, Helvetica, sans-serif">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex px-2 py-1 d-flex">
                      <div class="d-flex flex-column">
                        <h6 class="mb-0 text-sm">{{ $item -> jenisLoker }}</h6>
